...
This README is the outline for a possible R package 
...
by filing an [issue](https://github.com/poissonconsulting/deckr/issues)**.
...
of the vectors would specify the classes of the columns.
...
Missing values, ranges and specific values would work 
the same for integer, 
numeric, and Date vectors. With logical values two and 
three or more non-missing values would behave identically, i.e.,
