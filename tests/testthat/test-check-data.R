...
test_that("check_data min_row and max_row", {
  ...
  expect_error(check_data(x, min_row = -1), "min_row must be a count")
  expect_error(check_data(x, min_row = ""), "min_row must be a count")

  expect_error(check_data(x, max_row = -1), "max_row must be a count")
  expect_error(check_data(x, max_row = ""), "max_row must be a count")
})
